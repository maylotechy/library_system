                ...
                <div class="row">
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary btn-block" id="loginBtn">
                            <i class="fas fa-spinner fa-spin mr-2 d-none" id="loginSpinner"></i>
                            <span id="loginBtnText">Sign In</span>
                        </button>
                    </div>
                </div>
            <p class="mt-3 mb-1">
                <a href="students/registration.php">Register a new membership</a>
            </p>
        </div>
    </div>
</div>
                    ...
                    if(response.status === 'success') {
                        ...
                        setTimeout(function() {
                            if(response.user_type === 'student') {
                                window.location.href = 'students/student_dashboard.php';
